...
public class BookingService {
    ...
    public String createBooking(Booking booking) throws Exception {
        ...
        String insertBookingQuery = "INSERT INTO booking (booking_id, room_id, employee_id, customer_id, date_of_booking, length_of_stay) VALUES (?, ?, ?, ?, ?, ?);";
        ...
        try {
            ...
            stmt.setDate(5, booking.getDateOfBooking());
            stmt.setInt(6, booking.getLengthOfStay());
    ...
    public String updateBooking(Booking booking) throws Exception {
        ...
        String sql = "UPDATE booking SET booking_id=?, room_id=?, employee_id=?, customer_id=?, date_of_booking=?, length_of_stay=? WHERE booking_id=?;";
